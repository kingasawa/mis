...
module.exports = {
  ...
  quick_add: async (params) => {
    ...
    let { itemId, owner, stock, title, description, price, brand, upc, size, color, images, category, sku, tags, mpn } = params
    if(stock !== 'Available'){
      return {
        error: 'not available'
      }
    ...
    let createData = {
      title,price,brand,images,sku,tags,mpn,
      wip:itemId,
    ...
    Post.create(createData).then((postCreated)=>{
