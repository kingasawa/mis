...
(function(root, factory) {
  ...
  Color.prototype = {
    ...
    // parse bootstrap-colorpicker string to HSB
    /**
     * @protected
     * @param {String} strVal
    ...
    /**
     * @param {String} strVal
     * @returns {Object} Object containing h,s,b,bootstrap-colorpicker,format properties or FALSE if failed to parse
     */
    ...
    getValidFallbackFormat: function() {
      ...
      return 'rgba'; // By default, return bootstrap-colorpicker format that will not lose the alpha info
    },
    /**
     *
    ...
    // bootstrap-colorpicker set of RE's that can match strings and generate color tuples.
  ...
  var defaults = {
    ...
    color: false, //forces bootstrap-colorpicker color
    format: false, //forces bootstrap-colorpicker format
    input: 'input', // children input selector
    container: false, // container selector
    component: '.add-on, .input-group-addon', // children component selector
    fallbackColor: false, // fallback color value. null = keeps current color.
    fallbackFormat: 'hex', // fallback color format
    hexNumberSignPrefix: true, // put bootstrap-colorpicker '#' (number sign) before hex strings
    sliders: {
      saturation: {
        maxLeft: 100,
        maxTop: 100,
  ...
  Colorpicker.prototype = {
    ...
    /**
     * Creates bootstrap-colorpicker new color using the instance options
     * @protected
     * @param {String} val
     * @returns {Color}
     */
  ...
  $.fn.colorpicker = function(option) {
    ...
    var $jq = this.each(function() {
      ...
      if (typeof option === 'string') {
        ...
        } else { // its bootstrap-colorpicker property ?
          if (apiArgs.length) {
            // set property
